...
namespace VELDDev.AvaloniaDSL
{
	...
	/// </summary>
	[global::System.Runtime.InteropServices.Guid(Constants.AvaloniaEditorFactoryId)]
	internal partial class AvaloniaEditorFactory : AvaloniaEditorFactoryBase
	{
		/// <summary>
		/// Constructs a new AvaloniaEditorFactory.
		/// </summary>
		public AvaloniaEditorFactory(global::System.IServiceProvider serviceProvider)
	...
	/// </summary>
	internal abstract class AvaloniaEditorFactoryBase : DslShell::ModelingEditorFactory
	{
		/// <summary>
		/// Constructor.
		/// </summary>
		/// <param name="serviceProvider">Service provider used to access VS services.</param>
		protected AvaloniaEditorFactoryBase(global::System.IServiceProvider serviceProvider) : base(serviceProvider)
		{
		}
		...
		public override DslShell::ModelingDocData CreateDocData(string fileName, VSShellInterop::IVsHierarchy hierarchy, uint itemId)
		{
			...
			return new AvaloniaDocData(this.ServiceProvider, typeof(AvaloniaEditorFactory).GUID);
		}
		...
		protected override DslShell::ModelingDocView CreateDocView(DslShell::ModelingDocData docData, string physicalView, out string editorCaption)
		{
			...
			return new AvaloniaDocView(docData, this.ServiceProvider);
		}
	}
}
