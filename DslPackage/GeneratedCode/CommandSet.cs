...
namespace VELDDev.AvaloniaDSL
{
	...
	/// </summary>
	internal partial class AvaloniaCommandSet : AvaloniaCommandSetBase
	{
		/// <summary>
		/// Constructs a new AvaloniaCommandSet.
		/// </summary>
		public AvaloniaCommandSet(global::System.IServiceProvider serviceProvider) 
	...
	/// </summary>
	internal abstract class AvaloniaCommandSetBase : DslShell::CommandSet
	{
		/// <summary>
		/// Constructs a new AvaloniaCommandSetBase.
		/// </summary>
		protected AvaloniaCommandSetBase(global::System.IServiceProvider serviceProvider) : base(serviceProvider)
		{
		}
		...
		protected override global::System.Collections.Generic.IList<global::System.ComponentModel.Design.MenuCommand> GetMenuCommands()
		{
			...
			menuCommand = new DslShell::CommandContextBoundMenuCommand(this.ServiceProvider,
				...
				Constants.ViewAvaloniaExplorerCommand,
				typeof(AvaloniaEditorFactory).GUID);
		...
		{
			AvaloniaExplorerToolWindow explorer = this.AvaloniaExplorerToolWindow;
			if (explorer != null)
			{
				explorer.Show();
			}
		...
		protected AvaloniaDocData CurrentAvaloniaDocData
		{
			get
			{
				return this.MonitorSelection.CurrentDocument as AvaloniaDocData;
			}
		}
		...
		/// </summary>
		[global::System.Diagnostics.CodeAnalysis.SuppressMessage("Microsoft.Performance", "CA1811:AvoidUncalledPrivateCode")]
		protected AvaloniaDocView CurrentAvaloniaDocView
		{
			get
			{
				return this.MonitorSelection.CurrentDocumentView as AvaloniaDocView;
			}
		}
		...
		/// </summary>
		protected AvaloniaExplorerToolWindow AvaloniaExplorerToolWindow
		{
			get
			{
				AvaloniaExplorerToolWindow explorerWindow = null;
				...
				if (package != null)
				{
					explorerWindow = package.GetToolWindow(typeof(AvaloniaExplorerToolWindow), true) as AvaloniaExplorerToolWindow;
				}
		...
		protected object ExplorerSelection
		{
			get
			{
				...
				AvaloniaExplorerToolWindow explorerWindow = this.AvaloniaExplorerToolWindow;
	...
	/// Double-derived class to allow easier code customization.
	/// </summary>
	internal partial class AvaloniaClipboardCommandSet : AvaloniaClipboardCommandSetBase
	{
		/// <summary>
		/// Constructs a new AvaloniaClipboardCommandSet.
		/// </summary>
		public AvaloniaClipboardCommandSet(global::System.IServiceProvider serviceProvider)
			: base(serviceProvider)
		{
		}
	}
	...
	/// </summary>
	internal abstract partial class AvaloniaClipboardCommandSetBase : DslShell::ClipboardCommandSet
	{
		/// <summary>
		/// Constructs a new AvaloniaClipboardCommandSetBase.
		/// </summary>
		protected AvaloniaClipboardCommandSetBase(global::System.IServiceProvider serviceProvider)
			: base(serviceProvider)
		{
		}
