...
namespace VELDDev.AvaloniaDSL
{
	...
	/// </summary>
	internal partial class AvaloniaDocData : AvaloniaDocDataBase
	{
		/// <summary>
		/// Constructs a new AvaloniaDocData.
		/// </summary>
		public AvaloniaDocData(global::System.IServiceProvider serviceProvider, global::System.Guid editorFactoryId) 
	...
	/// <summary>
	/// Class which represents a Avalonia document in memory.
	/// </summary>
	internal abstract partial class AvaloniaDocDataBase : DslShell::ModelingDocData
	{
		/// <summary>
		...
		/// <summary>
		/// Constructs a new AvaloniaDocDataBase.
		/// </summary>
		protected AvaloniaDocDataBase(global::System.IServiceProvider serviceProvider, global::System.Guid editorFactoryId) : base(serviceProvider, editorFactoryId)
		{
		}
		...
		protected override string FormatList
		{
			get
			{
				return global::VELDDev.AvaloniaDSL.AvaloniaDomainModel.SingletonResourceManager.GetString("FormatList"); 
			}
		}
		...
		protected virtual bool HandleBindingFailure(global::System.Exception exception)
		{
			...
			string errorMessage = string.Format(global::System.Globalization.CultureInfo.CurrentCulture,
				global::VELDDev.AvaloniaDSL.AvaloniaDomainModel.SingletonResourceManager.GetString("BindingErrorOccurred"),
				exception.ToString());
		...
		protected override global::System.Collections.Generic.IList<global::System.Type> GetDomainModels()
		{
			...
			allTypes.Add(typeof(global::VELDDev.AvaloniaDSL.AvaloniaDomainModel));
		...
		protected virtual global::System.Collections.Generic.IEnumerable<global::System.Type> GetExtensionDomainModels()
		{
			...
			global::System.Collections.Generic.IEnumerable<global::System.Type> extensionDomainModels = this.ExtensionLocator.GetExtendingDomainModels(typeof(global::VELDDev.AvaloniaDSL.AvaloniaDomainModel));
		...
		protected override void Load(string fileName, bool isReload)
		{
			...
			global::VELDDev.AvaloniaDSL.ExampleModel modelRoot = null;
			...
			global::VELDDev.AvaloniaDSL.AvaloniaDomainModel.EnableDiagramRules(this.Store);
			string diagramFileName = fileName + this.DiagramExtension;
			
			modelRoot = global::VELDDev.AvaloniaDSL.AvaloniaSerializationHelper.Instance.LoadModelAndDiagram(serializationResult, this.GetModelPartition(), fileName, this.GetDiagramPartition(), diagramFileName, schemaResolver, null /* no load-time validation */, this.SerializerLocator);
			...
			{	
				...
				throw new global::System.InvalidOperationException(global::VELDDev.AvaloniaDSL.AvaloniaDomainModel.SingletonResourceManager.GetString("CannotOpenDocument"));
			}
			else
			{
						...
						if (itemId != global::Microsoft.VisualStudio.VSConstants.VSITEMID_NIL)
						{
							...
							if (this.diagramDocumentLockHolder == null)
							{
								throw new global::System.InvalidOperationException(string.Format(global::System.Globalization.CultureInfo.CurrentCulture,
													global::VELDDev.AvaloniaDSL.AvaloniaDomainModel.SingletonResourceManager.GetString("CannotCloseExistingDiagramDocument"),
													diagramFileName));
							}
						}
					}
		...
		{
			DslModeling::SerializationResult serializationResult = new DslModeling::SerializationResult();
			global::VELDDev.AvaloniaDSL.ExampleModel modelRoot = (global::VELDDev.AvaloniaDSL.ExampleModel)this.RootElement;
			...
			{
				global::VELDDev.AvaloniaDSL.AvaloniaDSLDiagram diagram = diagrams[0] as global::VELDDev.AvaloniaDSL.AvaloniaDSLDiagram;
				if (diagram != null)
				{
					string diagramFileName = fileName + this.DiagramExtension;
					try
					{
						...
						global::VELDDev.AvaloniaDSL.AvaloniaSerializationHelper.Instance.SaveModelAndDiagram(serializationResult, modelRoot, fileName, diagram, diagramFileName, this.Encoding, false);
					}
					finally
					{
			...
			{
				global::VELDDev.AvaloniaDSL.AvaloniaSerializationHelper.Instance.SaveModel(serializationResult, modelRoot, fileName, this.Encoding, false);
			}
			// Report serialization messages.
			this.SuspendErrorListRefresh();
			try
			...
			if (serializationResult.Failed)
			{	// Save failed.
				throw new global::System.InvalidOperationException(global::VELDDev.AvaloniaDSL.AvaloniaDomainModel.SingletonResourceManager.GetString("CannotSaveDocument"));
			}
		}
		/// <summary>
			...
			if (diagrams.Count > 0)
			{
				...
				if (diagram != null)
				{
					try
					{
						...
						global::VELDDev.AvaloniaDSL.AvaloniaSerializationHelper.Instance.SaveDiagram(serializationResult, diagram, fileName, this.Encoding, false);
					}
					finally
					{
		...
		protected override string SerializedModel
		{
			get
			{
				global::VELDDev.AvaloniaDSL.ExampleModel modelRoot = this.RootElement as global::VELDDev.AvaloniaDSL.ExampleModel;
				string modelFile = string.Empty;
				if (modelRoot != null)
				{
					modelFile = global::VELDDev.AvaloniaDSL.AvaloniaSerializationHelper.Instance.GetSerializedModelString(modelRoot, this.Encoding);
				}
				return modelFile;
			}
		}
