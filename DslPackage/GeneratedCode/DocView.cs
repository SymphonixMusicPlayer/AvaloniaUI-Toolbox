...
namespace VELDDev.AvaloniaDSL
{
	...
	/// </summary>
	internal partial class AvaloniaDocView : AvaloniaDocViewBase
	{
		/// <summary>
		/// Constructs a new AvaloniaDocView.
		/// </summary>
		public AvaloniaDocView(DslShell::ModelingDocData docData, global::System.IServiceProvider serviceProvider)
	...
	/// </summary>
	internal abstract class AvaloniaDocViewBase : DslShell::SingleDiagramDocView
	{
		/// <summary>
		/// Constructs a new AvaloniaDocView.
		/// </summary>
		protected AvaloniaDocViewBase(DslShell::ModelingDocData docData, global::System.IServiceProvider serviceProvider) : base(docData, serviceProvider)
		{
		}
		...
		protected override bool LoadView()
		{
			...
			AvaloniaDocDataBase docData = this.DocData as AvaloniaDocDataBase;
			global::System.Diagnostics.Debug.Assert(docData != null, "DocData for AvaloniaDocViewBase should be an AvaloniaDocDataBase!");
			DslModeling::Partition diagramPartition = docData.GetDiagramPartition();
			if (diagramPartition != null)
			{
				global::System.Collections.ObjectModel.ReadOnlyCollection<global::VELDDev.AvaloniaDSL.AvaloniaDSLDiagram> diagrams = docData.GetDiagramPartition().ElementDirectory.FindElements<global::VELDDev.AvaloniaDSL.AvaloniaDSLDiagram>();
				if (diagrams.Count > 0)
				{
		...
		protected override string DefaultToolboxTabName
		{
			get
			{
				return global::VELDDev.AvaloniaDSL.AvaloniaToolboxHelper.DefaultToolboxTabName;
			}
		}
		...
		protected override int DefaultToolboxTabToolboxItemsCount
		{
			get
			{
				return global::VELDDev.AvaloniaDSL.AvaloniaToolboxHelper.DefaultToolboxTabToolboxItemsCount;			
			}
		}
		...
		protected override global::System.ComponentModel.Design.CommandID ContextMenuId
		{
			get
			{
				return Constants.AvaloniaDiagramMenu;
			}
		}
		...
		protected override void OnSelectionChanged(global::System.EventArgs e)
		{
			...
			if(global::VELDDev.AvaloniaDSL.AvaloniaHelpKeywordHelper.Instance != null)
			{
				DslModeling::ModelElement selectedElement = this.PrimarySelection as DslModeling::ModelElement;
				if(selectedElement != null)
				{
					string f1Keyword = global::VELDDev.AvaloniaDSL.AvaloniaHelpKeywordHelper.Instance.GetHelpKeyword(selectedElement);
					...
					if(presentationElement != null)
					{
						...
						if(selectedElement != null)
						{
							string modelElementKeyword = global::VELDDev.AvaloniaDSL.AvaloniaHelpKeywordHelper.Instance.GetHelpKeyword(selectedElement);
