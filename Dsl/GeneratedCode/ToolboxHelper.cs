...
namespace VELDDev.AvaloniaDSL
{
	...
	/// </remarks>
	public partial class AvaloniaToolboxHelper : AvaloniaToolboxHelperBase 
	{
		/// <summary>
		/// Constructs a new AvaloniaToolboxHelper.
		/// </summary>
		public AvaloniaToolboxHelper(global::System.IServiceProvider serviceProvider)
	...
	public abstract class AvaloniaToolboxHelperBase
	{
		/// <summary>
		/// Toolbox item filter string used to identify Avalonia toolbox items.  
		/// </summary>
		/// <remarks>
		/// See the MSDN documentation for the ToolboxItemFilterAttribute class for more information on toolbox
		/// item filters.
		/// </remarks>
		public const string ToolboxFilterString = "Avalonia.1.0";
		...
		/// <summary>
		/// Constructs a new AvaloniaToolboxHelperBase.
		/// </summary>
		protected AvaloniaToolboxHelperBase(global::System.IServiceProvider serviceProvider)
		{
		...
		public static string DefaultToolboxTabName
		{
			get
			{
				return global::VELDDev.AvaloniaDSL.AvaloniaDomainModel.SingletonResourceManager.GetString("AvaloniaDSLToolboxTab", global::System.Globalization.CultureInfo.CurrentUICulture);
			}
		}
		...
		public virtual DslDesign::ModelingToolboxItem GetToolboxItem(string itemId, DslModeling::Store store)
		{
			...
			global::System.Resources.ResourceManager resourceManager = global::VELDDev.AvaloniaDSL.AvaloniaDomainModel.SingletonResourceManager;
			global::System.Globalization.CultureInfo resourceCulture = global::System.Globalization.CultureInfo.CurrentUICulture;
			switch(itemId)
			{
				case "VELDDev.AvaloniaDSL.ButtonToolboxItem":
					// Add Button shape tool.
					result = new DslDesign::ModelingToolboxItem(
						"VELDDev.AvaloniaDSL.ButtonToolboxItem", // Unique identifier (non-localized) for the toolbox item.
						...
						"VELDDev.AvaloniaDSL.AvaloniaDSLToolboxTab", // Unique identifier (non-localized) for the toolbox item tab.
						resourceManager.GetString("AvaloniaDSLToolboxTab", resourceCulture), // Localized display name for the toolbox tab.
						...
						CreateElementToolPrototype(store, global::VELDDev.AvaloniaDSL.Button.DomainClassId), // ElementGroupPrototype (data object) representing model element on the toolbox.
		...
		protected DslModeling::Store ToolboxStore
		{
			...
			{ 
				if (toolboxStore==null)
				{
					...
					toolboxStore.LoadDomainModels(typeof(global::VELDDev.AvaloniaDSL.AvaloniaDomainModel));
