...
namespace VELDDev.AvaloniaDSL
{
	...
	/// </summary>
	public static partial class ButtonReferencesTargetsBuilder
	{
		...
		public static bool CanAcceptSource(DslModeling::ModelElement candidate)
		{
			...
			else if (candidate is global::VELDDev.AvaloniaDSL.Button)
			{ 
				return true;
			}
			else
		...
		public static bool CanAcceptSourceAndTarget(DslModeling::ModelElement candidateSource, DslModeling::ModelElement candidateTarget)
		{
			...
			{
				if (candidateSource is global::VELDDev.AvaloniaDSL.Button)
				{
					if (candidateTarget is global::VELDDev.AvaloniaDSL.Button)
					{
						global::VELDDev.AvaloniaDSL.Button sourceButton = (global::VELDDev.AvaloniaDSL.Button)candidateSource;
						global::VELDDev.AvaloniaDSL.Button targetButton = (global::VELDDev.AvaloniaDSL.Button)candidateTarget;
						if(targetButton == null || sourceButton == null || global::VELDDev.AvaloniaDSL.ButtonReferencesTargets.GetLinks(sourceButton, targetButton).Count > 0) return false;
						return true;
					}
				}
		...
		public static DslModeling::ElementLink Connect(DslModeling::ModelElement source, DslModeling::ModelElement target)
		{
			...
			{
				if (source is global::VELDDev.AvaloniaDSL.Button)
				{
					if (target is global::VELDDev.AvaloniaDSL.Button)
					{
						global::VELDDev.AvaloniaDSL.Button sourceAccepted = (global::VELDDev.AvaloniaDSL.Button)source;
						global::VELDDev.AvaloniaDSL.Button targetAccepted = (global::VELDDev.AvaloniaDSL.Button)target;
						DslModeling::ElementLink result = new global::VELDDev.AvaloniaDSL.ButtonReferencesTargets(sourceAccepted, targetAccepted);
