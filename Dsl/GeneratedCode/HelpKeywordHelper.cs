...
namespace VELDDev.AvaloniaDSL
{
	...
	/// </remarks>
	public partial class AvaloniaHelpKeywordHelper : AvaloniaHelpKeywordHelperBase 
	{
		
		/// <summary>
		/// Constructs a new AvaloniaHelpKeywordHelper.
		/// </summary>
		protected AvaloniaHelpKeywordHelper()
			: base() { }
			
		/// <summary>
		/// Single instance of the AvaloniaHelpKeywordHelper.
		/// </summary>
		public static AvaloniaHelpKeywordHelper Instance
		{
			get
			{
	...
	/// </summary>
	public abstract class AvaloniaHelpKeywordHelperBase
	{
		private global::System.Collections.Generic.Dictionary<string, string> helpKeywords;
		
		/// <summary>
		/// Constructs a new AvaloniaHelpKeywordHelperBase.
		/// </summary>
		protected AvaloniaHelpKeywordHelperBase()
			: base() { }
